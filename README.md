...
- **Travelers** — every few minutes a visitor from a sibling universe drifts through with their own familiar, watches whatever yours watches, greets your cursor, and leaves. Their home seed shows in the HUD — type it in to visit where they live. Each traveler is steered by a tiny neural network, and the population *evolves*: visits are scored by how they actually went, good minds enter a local gene pool, and most future visitors are mutated descendants of the ones you engaged with. (The whole "ML stack" is ~120 lines of dependency-free JS.)
