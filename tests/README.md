...
| `capsules_test` | Time capsules end-to-end: seal → drift (finite) → click-open → found; travelers ferry capsules to their home seeds with provenance, consuming no randomness when there is nothing to carry; Observatory markers; eviction keeps unopened notes; persistence. |
